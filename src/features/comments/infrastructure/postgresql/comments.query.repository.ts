...
import {commentModelOutput, CommentOutputDto} from "../../api/models/output/comment.output.dto";

@Injectable()
export class CommentsQueryRepository {
  constructor(protected repository: CommentsQueryRepositoryTypeOrm) {}

  async getCommentByd(id: string, userId: string | null): Promise<CommentOutputDto> {
