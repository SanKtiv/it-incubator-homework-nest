...
export type RequestToApiModelType = Model<RequestToApiDocument> & RequestToApiStaticMethodsType

type RequestToApiStaticMethodsType = {
    createRequest: (dto: {}, RequestToApiModel: RequestToApiModelType) => RequestToApiDocument
}
