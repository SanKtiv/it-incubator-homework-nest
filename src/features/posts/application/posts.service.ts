...
export class PostsService {
    ...
    async updateLikeStatus(id: string, dto: PostLikeStatusDto, userId: string): Promise<void> {
        ...
        const currentUser = postDocument.likesUsers.find(e => e.userId === userId)
        ...
        if (newStatus === 'None' && currentUser) {
            ...
            postDocument.likesUsers = postDocument.likesUsers.filter(e => e.userId !== userId)
        ...
        postDocument.likesUsers = postDocument.likesUsers.map(e => e.userId === userId ? likeUser : e)
